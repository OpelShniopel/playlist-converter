        ...
        <div className="flex items-center justify-between rounded-lg border border-border bg-background p-4">
          ...
          {user?.connectedServices?.youtube ? (
            ...
            <button
              ...
              className="rounded-md bg-red-600 px-4 py-2 text-white transition-colors hover:bg-opacity-90"
            >
              Connect
            </button>
          )}
        ...
        <div className="flex items-center justify-between rounded-lg border border-border bg-background p-4">
          ...
          {user?.connectedServices?.spotify ? (
            ...
            <button
              ...
              className="rounded-md bg-[#1DB954] px-4 py-2 text-white transition-colors hover:bg-opacity-90"
            >
              Connect
            </button>
          )}
